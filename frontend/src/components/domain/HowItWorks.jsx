  ...
  return (
    ...
    >
      <div className="text-center space-y-2">
        <p className="text-xs uppercase tracking-[0.22em] text-[#0F766E]">Wie es funktioniert</p>
        <h2 className="text-3xl font-semibold text-[#0B132B]">In drei Schritten startklar</h2>
      </div>
