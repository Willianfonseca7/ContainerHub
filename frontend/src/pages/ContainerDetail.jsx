...
export default function ContainerDetail() {
  ...
  if (loading) {
    return (
      <div className="py-10">
        <p className="text-[#6B7280] dark:text-slate-400">Laden...</p>
      </div>
    );
  }
    ...
    <div className="py-10 space-y-6">
      <Card className="p-6 space-y-3">
        <div className="flex items-center justify-between gap-3">
          <div>
            <p className="text-xs uppercase tracking-[0.18em] text-[#F59E0B]">Container</p>
      ...
      <Card className="p-6 space-y-4">
        <div className="space-y-1">
          <p className="text-xs uppercase tracking-[0.18em] text-[#F59E0B]">Reservierung</p>
          <h2 className="text-xl font-semibold text-[#111827] dark:text-slate-100">Anfrage senden</h2>
          <p className="text-sm text-[#6B7280] dark:text-slate-400">
