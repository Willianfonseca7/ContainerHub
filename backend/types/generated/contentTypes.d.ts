...
export interface ApiContactContact extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    status: Schema.Attribute.Enumeration<['new', 'read', 'resolved']> &
      Schema.Attribute.Required &
...
export interface ApiContainerModelContainerModel
  extends Struct.CollectionTypeSchema {
  collectionName: 'container_models';
  info: {
    displayName: 'container-model';
    pluralName: 'container-models';
    singularName: 'container-model';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    base_price: Schema.Attribute.String & Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::container-model.container-model'
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.String & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    size_m2: Schema.Attribute.Decimal & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    volume_m3: Schema.Attribute.Decimal;
  };
}
